...
This notebook aims to shows stats across all cells from Illumin and PacBio and then compare bam files from the Illumina and PacBio data subsampled down to a set of identical cell barcodes.

## PacBio vs Illumina comparison of methods.
...
pdf("Figures_2025_RevisionsNAR/Figure1B.pdf", width = 8, height = 19)
...
pdf("Figures_2025_RevisionsNAR/Figure1D.pdf", width = 11, height = 11)
p1
dev.off()
```
...
pdf("Figures_2025_RevisionsNAR/Figure2A.pdf", width=6, height=5)
p2 = ggplot() + 
...
pdf("Figures_2025_RevisionsNAR/Figure1B.pdf", width = 6, height = 5)
p2
dev.off()
...
pdf("Figures_2025_RevisionsNAR/Figure2D.pdf", width = 11, height = 11)
p3
dev.off()
...
pdf("Figures_2025_RevisionsNAR/Figure2E.pdf", width = 5, height = 5)
p5
dev.off()
```
...
pdf("Figures_2025_RevisionsNAR/Figure3D.pdf", width = 18, height = 11)
p7
dev.off()
...
Comparison of classification of the common tag Ids - Illumina (intron, exon, intergenic), PacBio (FSM, NNC, NIC, ISM etc.)
...
pdf("Figures_2025_RevisionsNAR/Figure3C.pdf", width = 15, height = 5)
p9
dev.off()
...
Using the reads from the common tag IDs we estimate how the proportion of tagIds corresponds between the two datasets within each read length bin and GC content bin.
...
pdf("Figures_2025_RevisionsNAR/Figure3B.pdf", width = 6, height = 6)
