...
pdf("Figures_2025_RevisionsNAR/PB_Artefacts_Reads_Isoforms.pdf", height=6, width=10)
merge(
    reasons_pbAnnot_df %>% 
        group_by(Sample, filter) %>% 
...
pdf("Figures_2025_RevisionsNAR/Classification_Reads_Isoforms.pdf", height=6, width=10)
...
pdf("Figures_2025_RevisionsNAR/Illumina_equivalents_PacBio_artefacts.pdf", height=4, width=6)
...
pdf("Figures_2025_RevisionsNAR/Genelength_CommonCells_filtereddata.pdf", width=8, height=5)
...
pdf("Figures_2025_RevisionsNAR/Length_pacBio_artefacts.pdf",width=7, height=5)
...
pdf("Figures_2025_RevisionsNAR/Pseudobulk_gene_expression_allcells_pacbio_vs_pacbiofilt.pdf", width=7, height=18)
op = par(mfrow=c(5,2), mar = c(3,4.5,2,2))
final_toCounts = NULL
n = 1
...
pdf("Figures_2025_RevisionsNAR/UMAP_Plots_CommonCells_PacBio_filtered.pdf", height=7, width=15)
...
for (i in names(merged_data)){
  filename = paste0(i,"GroupwiseDEPlot.pdf")
